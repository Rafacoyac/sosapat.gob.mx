  ...
  <header class="u-clearfix u-header u-white u-header" id="sec-1ea1"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center-xs u-clearfix u-section-1" src="" id="carousel_e99d">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-expand-resize u-expanded-height u-image u-image-contain u-image-1" src="/images/Untitled-245.png" data-image-width="1283" data-image-height="1080">
        <div class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-group u-shape-rectangle u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h1 class="u-custom-font u-font-oswald u-text u-text-palette-3-base u-title u-text-1">Ley de Disciplina Financiera</h1>
            <p class="u-large-text u-text u-text-variant u-text-2">Información financiera contable de acuerdo con los lineamientos en los articulos 58 y 58 de la LDF.</p>
          </div>
        </div>
      </div>
    </section>
                                            ...
                                            <div class="collapse" id="trimestre2do22">
                                                <div >  
                                                    <table class="table">           
                                                        ...
                                                        $difCols1=0;//($colsFinMes1+1)-$colsInMes1;
                                                        $difCols2=0;//($colsFinMes2+1)-$colsInMes2;
                                                    ...
                                                    <table class="table">           
                                                        ...
                                                        for ($row = $colsInMes1; $row <= $colsFinMes1; $row++){ 
                                                            ...
                                                            <tr>
                                                                <th scope='row'><?php echo $num;?></th>
                                                                <th><?php echo $sheet->getCell("D".$row)->getValue();?></th>
                                                                <th><a href="<?php echo $sheet->getCell("E".$row)->getValue();?>" target="_blank">Ver Información</a></th>
                                                            </tr>
                                                            <?php    
                                                        }
